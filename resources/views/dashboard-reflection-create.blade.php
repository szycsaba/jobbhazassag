        ...
        <div class="max-w-[1220px] w-[100%] shadow-sm bg-white m-auto mt-[32px] rounded-lg p-[16px] flex flex-col">
            ...
            <div class="flex flex-row font-medium p-[5px] text-gray-700 border-b-2 pb-[8px] border-gray-200 mb-4">
                <div class="w-[100%] flex flex-row justify-end gap-[5px]">
                    <button type="submit" form="reflection-create-form"
                    ...
                    <a class="w-[30%] h-[32px] flex justify-center items-center p-[12px] rounded-md bg-red-500 text-sm font-semibold text-white focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-red-500"
                       href="{{ route('dashboard-reflections') }}">
                        Elvetés
                    </a>
                </div>
            </div>

            <form id="reflection-create-form" method="POST" action="{{ route('dashboard-reflections.store') }}" data-crud="create" data-redirect="{{ route('dashboard-reflections') }}" data-loading-title="Mentés folyamatban" data-loading-text="Kérjük várjon..." data-success-title="Sikeres!" data-error-title="Hiba!">
                @csrf

                <!-- Önismeret címe -->
                <div class="mb-4">
                    <label for="title" class="block text-sm font-medium text-gray-700 mb-2">Önismeret címe</label>
                    <input type="text" id="title" name="title" class="w-full border-2 rounded p-2" placeholder="Írd ide az önismeret címét..." required>
                </div>
